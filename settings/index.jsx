function clockfaceSettings(props) {
  return (
    <Page>
      <Section 
          description={<Text align="center">Se os ajustes não atualizarem automaticamente, entre em um aplicativo e volte para tela inicial para atualizar.</Text>}
          title={<Text bold>Configurações do relógio</Text>}>
        <Select
          label="Fonte"
          settingsKey="font"
          options={[
        ...
        <Select
          ...
          settingsKey="image"
          options={[
            {name:"Black Panther", value: "myImage.png"},
            {name:"Miles Morales", value: "Miles.png"},
            {name:"Gravity Falls", value: "Bill.png"},
            {name:"Pericles", value: "Pericles.png"},
            {name:"Tim Maia", value: "tim.png"}
          ]}
        />
        <Toggle
        ...
        <Toggle
          ...
          label="Mostrar distância em metros"
        />
        <Toggle
